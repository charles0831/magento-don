...
namespace Eltrino\Region\Plugin\Multishipping\Block\Checkout;
 ...
 * @package Eltrino\Region\Plugin\Model\Address
 */
class AddressesPlugin
{
    ...
    public function afterGetAddressOptions(
        ...
        foreach ($result as $key => $address) {
            ...
            $address = $customer->getAddressById($address['value'])->getDataModel();
