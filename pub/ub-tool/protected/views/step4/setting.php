            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="checkbox">
                        ...
                        <input type="checkbox" <?php echo ($selectedAll || $totalCategories == sizeof($selectedCategoryIds)) ? "checked" : ''; ?>
...
<script type="text/javascript">
    ...
    (function($) {
        ...
        //check/un-check
        var $checkAll = $('INPUT[name="select_all_categories"]');
        var $categoriesTree = $('.tree INPUT[name="category_ids[]"]');

        $.isCheckedAll = function() {
            var rs = true;
            $categoriesTree.each(function(i, el) {
        ...
        $categoriesTree.on('change', function() {
            if (!$(this).hasClass('read-only')) {
                ...
                //update state for check all element
                if (!value && $checkAll.prop("checked")) {
