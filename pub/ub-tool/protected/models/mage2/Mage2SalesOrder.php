...
class Mage2SalesOrder extends Mage2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			relation_parent_id, relation_parent_real_id, x_forwarded_for', 'length', 'max'=>32),
			array('coupon_code, protect_code, shipping_description, discount_description, coupon_rule_name, store_name', 'length', 'max'=>255),
