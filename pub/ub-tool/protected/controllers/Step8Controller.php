...
class Step8Controller extends BaseController
{
    ...
    public function actionSetting()
    {
        ...
        if ($result['allowed']) {
            ...
            $objects = array(
                'cms' => [
                    'label' => Yii::t('frontend', 'CMS Data'),
                    'related' => [
                        'cms_block' => Yii::t('frontend', 'CMS Blocks'),
                        'cms_page' => Yii::t('frontend', 'CMS Pages')
                    ]
                ],
            ...
            if (Yii::app()->request->isPostRequest) {
                ...
                if (sizeof($selectedSalesObjects)) {
                    ...
                    if ($selectedObjects) {
                        ...
                        if ($step->update()) {
                            ...
                            Yii::app()->user->setFlash(
                                'success',
                                Yii::t('frontend', 'Your settings have been saved successfully.<br/>You have finished all pre-migration settings. Let\'s start proceeding migration now.')
                            );
                            //go to migrate step
                    ...
                    Yii::app()->user->setFlash(
                        'note',
                        Yii::t('frontend', 'Reminder! You have to complete all settings in the step #7 (Sales) first')
                    );
                }
            }
            ...
            Yii::app()->user->setFlash(
                'note',
                Yii::t('frontend',"Reminder! You need to finish settings in the step #%s", array("%s" => $result['back_step_index']))
            );
    ...
    public function actionRun()
    {
        ...
        if ($check['allowed']) {
            ...
            $max0 = $offset0 = $max00 = $offset00 = $max1 = $offset1 = $max2 = $offset2 = $max3 = $offset3 = 0;
            $max4 = $offset4 = $max5 = $offset5 = $max6 = $offset6 = $max7 = $offset7 = $max8 = $offset8 = 0;
            $max9 = $offset9 = $max10 = $offset10 = $max11 = $offset11 = $max12 = $offset12 = $max13 = $offset13 = 0;
            $max14 = $offset14 = $max15 = $offset15 = $max16 = $offset16 = $max17 = $offset17 = $max18 = $offset18 = 0;
            try {
                if ($selectedObjects) {
                    /**
                     * Migrate CMS Data
                     */
                    if (in_array('cms', $selectedObjects)) {
                        /**
                         * Table: cms_block
                         */
                        if (in_array('cms_block', $selectedChildObjects)) {
                            $condition = '';
                            $max0 = Mage1CmsBlock::model()->count($condition);
                            $offset0 = UBMigrate::getCurrentOffset(8, Mage1CmsBlock::model()->tableName());
                            //get list objects by limit and offset
                            $list0 = UBMigrate::getListObjects(
                                'Mage1CmsBlock',
                                $condition,
                                $offset0,
                                $this->limit,
                            ...
                            if ($list0) {
                                $this->_migrateCMSBlocks($list0, $mappingStores);
                            }
                        }
                        /**
                         * Table: cms_page
                         */
                        $canRun = $offset0 >= $max0 ? 1 : 0;
                        if (in_array('cms_page', $selectedChildObjects) && $canRun) {
                            $condition = "";
                            $max00 = Mage1CmsPage::model()->count($condition);
                            $offset00 = UBMigrate::getCurrentOffset(8, Mage1CmsPage::model()->tableName());
                            //get list objects by limit and offset
                            $list00 = UBMigrate::getListObjects(
                                'Mage1CmsPage',
                                $condition,
                                $offset00,
                                $this->limit,
                            ...
                            if ($list00) {
                                $this->_migrateCmsPages($list00, $mappingStores);
                            }
                        }
                     ...
                     */
                    $canRun = ($offset0 >= $max0 AND $offset00 >= $max00) ? 1 : 0;
                    if (in_array('review', $selectedObjects) && $canRun) {
                        /**
                         * Table: review
                         */
                        /**
                     ...
                     * Migrate rating data
                     */
                    $canRun = ($offset0 >= $max0 AND $offset00 >= $max00 AND $offset1 >= $max1 AND $offset2 >= $max2) ? 1 : 0;
                    if (in_array('rating', $selectedObjects) AND $canRun) {
                         ...
                         */
                        $canRun = ($offset0 >= $max0 AND $offset00 >= $max00 AND $offset1 >= $max1
                            AND $offset2 >= $max2 AND $offset3 >= $max3) ? 1 : 0;
                         ...
                         */
                        $canRun = ($offset0 >= $max0 AND $offset00 >= $max00 AND $offset1 >= $max1
                            AND $offset2 >= $max2 AND $offset3 >= $max3 AND $offset4 >= $max4) ? 1 : 0;
                     ...
                     */
                    $canRun = ($offset0 >= $max0 AND $offset00 >= $max00 AND $offset1 >= $max1
                        AND $offset2 >= $max2 AND $offset3 >= $max3 AND $offset4 >= $max4 AND $offset5 >= $max5) ? 1 : 0;
                     ...
                     */
                    $canRun = ($offset0 >= $max0 AND $offset00 >= $max00 AND $offset1 >= $max1 AND $offset2 >= $max2
                        AND $offset3 >= $max3 AND $offset4 >= $max4 AND $offset5 >= $max5 AND $offset6 >= $max6) ? 1 : 0;
                     ...
                     */
                    $canRun = ($offset0 >= $max0 AND $offset00 >= $max00 AND $offset1 >= $max1 AND $offset2 >= $max2
                        AND $offset3 >= $max3 AND $offset4 >= $max4 AND $offset5 >= $max5 AND $offset6 >= $max6 AND $offset7 >= $max7) ? 1 : 0;
                    if (in_array('tax_data', $selectedObjects) AND $canRun) {
                         ...
                         */
                        $canRun = ($offset0 >= $max0 AND $offset00 >= $max00 AND $offset1 >= $max1 AND $offset2 >= $max2
                            AND $offset3 >= $max3 AND $offset4 >= $max4 AND $offset5 >= $max5 AND $offset6 >= $max6
                    ...
                    if (in_array('email_template_newsletter', $selectedObjects) AND $canRun) {
                        ...
                        $canRun = ($offset0 >= $max0 AND $offset00 >= $max00 AND $offset1 >= $max1 AND $offset2 >= $max2
                            AND $offset3 >= $max3 AND $offset4 >= $max4 AND $offset5 >= $max5 AND $offset6 >= $max6
                            AND $offset7 >= $max7 AND $offset8 >= $max8 AND $offset9 >= $max9 AND $offset10 >= $max10
                            AND $offset11 >= $max11 AND $offset12 >= $max12 AND $offset13 >= $max13 AND $offset14 >= $max14) ? 1 : 0;
                        ...
                        $canRun = ($offset0 >= $max0 AND $offset00 >= $max00 AND $offset1 >= $max1 AND $offset2 >= $max2
                            AND $offset3 >= $max3 AND $offset4 >= $max4 AND $offset5 >= $max5 AND $offset6 >= $max6
                            AND $offset7 >= $max7 AND $offset8 >= $max8 AND $offset9 >= $max9 AND $offset10 >= $max10
                            AND $offset11 >= $max11 AND $offset12 >= $max12 AND $offset13 >= $max13 AND $offset14 >= $max14 AND $offset15 >= $max15) ? 1 : 0;
                ...
                if ($this->errors) {
                    ...
                    if ($offset0 >= $max0 AND $offset00 >= $max00 AND $offset1 >= $max1 AND $offset2 >= $max2 AND $offset3 >= $max3
                        AND $offset4 >= $max4 AND $offset5 >= $max5 AND $offset6 >= $max6 AND $offset7 >= $max7 AND $offset8 >= $max8
                        ...
                        if ($step->updateStatus(UBMigrate::STATUS_FINISHED)) {
                            ...
                            UBMigrate::updateCurrentOffset(Mage1CmsBlock::model()->tableName(), $max0, $this->stepIndex);
                            UBMigrate::updateCurrentOffset(Mage1CmsPage::model()->tableName(), $max00, $this->stepIndex);
                        ...
                        if ($max0) {
                            ...
                            $entityName = Mage1CmsBlock::model()->tableName();
                        }
                        if ($max00) {
                            $max = $max00;
                            $offset = $offset00 + $this->limit;
                            $entityName = Mage1CmsPage::model()->tableName();
                        }
                        if ($max1) {
                            $max = $max1;
                            $offset = $offset1 + $this->limit;
                            $entityName = Mage1Review::model()->tableName();
                        }
                        if ($max2) {
                            $max = $max2;
                            $offset = $offset2 + $this->limit;
                            $entityName = Mage1ReviewEntitySummary::model()->tableName();
                        }
                        if ($max3) {
                            $max = $max3;
                            $offset = $offset3 + $this->limit;
                            $entityName = Mage1Rating::model()->tableName();
                        }
                        if ($max4) {
                            $max = $max4;
                            $offset = $offset4 + $this->limit;
                            $entityName = Mage1RatingOptionVote::model()->tableName();
                        }
                        if ($max5) {
                            $max = $max5;
                            $offset = $offset5 + $this->limit;
                            $entityName = Mage1RatingOptionVoteAggregated::model()->tableName();
                        }
                        if ($max6) {
                            $max = $max6;
                            $offset = $offset6 + $this->limit;
                            $entityName = Mage1CatalogProductEntityTierPrice::model()->tableName();
                        }
                        if ($max7) {
                            $max = $max7;
                            $offset = $offset7 + $this->limit;
                            $entityName = Mage1CatalogProductEntityGroupPrice::model()->tableName();
                        }
                        if ($max8) {
                            $max = $max8;
                            $offset = $offset8 + $this->limit;
                            $entityName = Mage1TaxClass::model()->tableName();
                        }
                        if ($max9) {
                            $max = $max9;
                            $offset = $offset9 + $this->limit;
                            $entityName = Mage1TaxCalculationRate::model()->tableName();
                        }
                        if ($max10) {
                            $max = $max10;
                            $offset = $offset10 + $this->limit;
                            $entityName = Mage1TaxCalculationRule::model()->tableName();
                        }
                        if ($max11) {
                            $max = $max11;
                            $offset = $offset11 + $this->limit;
                            $entityName = Mage1TaxOrderAggregatedCreated::model()->tableName();
                        }
                        if ($max12) {
                            $max = $max12;
                            $offset = $offset12 + $this->limit;
                            $entityName = Mage1TaxOrderAggregatedUpdated::model()->tableName();
                        }
                        if ($max13) {
                            $max = $max13;
                            $offset = $offset13 + $this->limit;
                            $entityName = Mage1Catalogrule::model()->tableName();
                        }
                        if ($max14) {
                            $max = $max14;
                            $offset = $offset14 + $this->limit;
                            $entityName = Mage1EmailTemplate::model()->tableName();
                        }
                        if ($max15) {
                            $max = $max15;
                            $offset = $offset15 + $this->limit;
                            $entityName = Mage1NewsletterSubscriber::model()->tableName();
                        }
                        if ($max16) {
                            $max = $max16;
                            $offset = $offset16 + $this->limit;
                            $entityName = Mage1NewsletterTemplate::model()->tableName();
                        }
                        if ($max17) {
                            $max = $max17;
                            $offset = $offset17 + $this->limit;
                            $entityName = Mage1EAVEntityStore::model()->tableName();
                        }
                        if ($max18) {
                            $max = $max18;
                            $offset = $offset18 + $this->limit;
                            $entityName = Mage1DownloadableLinkPurchased::model()->tableName();
                        }
                        ...
                        //update result to respond
                        $rs['status'] = 'ok';
                        $rs['percent_up'] = UBMigrate::getPercentUp(20, $max, $this->limit);
                        ...
                        if (isset($list0) AND $list0) {
                            $msg .= ' %s1 CMS Blocks;';
                            $data['%s1'] = sizeof($list0);
                        } elseif (isset($list00) AND $list00) {
                            $msg .= ' %s1 CMS Pages;';
                            $data['%s1'] = sizeof($list00);
                        } elseif (isset($list1) AND $list1) {
                            $msg .= ' %s1 Reviews;';
    ...
    private function _migrateCMSBlocks($models, $mappingStores)
    {
        foreach ($models as $model) {
            $m2Id = UBMigrate::getM2EntityId('8_cms', 'cms_block', $model->block_id);
            if (is_null($m2Id)) {
                //add new
                $model2 = new Mage2CmsBlock();
                $model2->block_id = null;
                $model2->title = $model->title;
                $model2->identifier = $model->identifier;
                $model2->content = $model->content;
                $model2->creation_time = $model->creation_time;
                $model2->update_time = $model->update_time;
                $model2->is_active = $model->is_active;
            } else {
                //update
                $model2 = Mage2CmsBlock::model()->find("block_id = {$m2Id}");
                $model2->title = $model->title;
                $model2->identifier = $model->identifier;
                $model2->content = $model->content;
                $model2->update_time = $model->update_time;
            ...
            if (!$model2->save()) {
                ...
                if (is_null($m2Id)) {
                    ...
                    UBMigrate::log([
                        ...
                        'm1_id' => $model->block_id,
                        'm2_id' => $model2->block_id,
                        'm2_model_class' => get_class($model2),
                        'm2_key_field' => 'block_id',
            ...
            if ($model2->block_id) {
                 ...
                 */
                $blockStores = Mage1CmsBlockStore::model()->findAll("block_id = {$model->block_id}");
                if ($blockStores) {
                    foreach ($blockStores as $blockStore) {
                        $storeId2 = isset($mappingStores[$blockStore->store_id])
                            ? $mappingStores[$blockStore->store_id]
                            : null;
                        if (!is_null($storeId2)) {
                            $blockStore2 = Mage2CmsBlockStore::model()->find("block_id = {$model2->block_id} AND store_id = {$storeId2}");
                            if (!$blockStore2) {
                                $blockStore2 = new Mage2CmsBlockStore();
                                $blockStore2->store_id = $storeId2;
                                $blockStore2->block_id = $model2->block_id;
                            } else {
                                //update
                                $blockStore2->store_id = $storeId2;
                            }
                            //save/update
                            if (!$blockStore2->save()) {
                                $this->errors[] = get_class($blockStore2) . ": " . UBMigrate::getStringErrors($blockStore2->getErrors());
                            } else {
                                $this->_traceInfo();
                            }
                        }
    ...
    private function _migrateCMSPages($models, $mappingStores)
    {
        foreach ($models as $model) {
            $m2Id = UBMigrate::getM2EntityId('8_cms', 'cms_page', $model->page_id);
            if (is_null($m2Id)) {
                //add new
                $model2 = new Mage2CmsPage();
                $model2->page_id = null;
                $model2->title = $model->title;
                //Because M2 was changed 'root_template' to 'page_layout' field
                $model2->page_layout = self::_getM2PageLayout($model->root_template);
                $model2->custom_root_template = self::_getM2PageLayout($model->custom_root_template);
                $model2->identifier = $model->identifier;
                //Because meta_title is a new field in M2
                $model2->meta_title = $model->title;
                $model2->meta_keywords = $model->meta_keywords;
                $model2->meta_description = $model->meta_description;
                $model2->content_heading = $model->content_heading;
                $model2->content = $model->content;
                $model2->creation_time = $model->creation_time;
                $model2->update_time = $model->update_time;
                ...
                //update
                $model2 = Mage2CmsPage::model()->find("page_id = {$m2Id}");
                $model2->title = $model->title;
                //Because M2 was changed 'root_template' to 'page_layout' field
                $model2->page_layout = self::_getM2PageLayout($model->root_template);
                $model2->custom_root_template = self::_getM2PageLayout($model->custom_root_template);
            ...
            if (!$model2->save()) {
                ...
                if (is_null($m2Id)) {
                    ...
                    UBMigrate::log([
                        'entity_name' => $model->tableName(),
                        'm1_id' => $model->page_id,
                        'm2_id' => $model2->page_id,
                        'm2_model_class' => get_class($model2),
                        'm2_key_field' => 'page_id',
                        'can_reset' => UBMigrate::RESET_YES,
                        'step_index' => "8Cms"
                    ]);
                }
            ...
            if ($model2->page_id) {
                 ...
                 */
                $pageStores = Mage1CmsPageStore::model()->findAll("page_id = {$model->page_id}");
                if ($pageStores) {
                    foreach ($pageStores as $pageStore) {
                        $storeId2 = isset($mappingStores[$pageStore->store_id])
                            ? $mappingStores[$pageStore->store_id]
                            : null;
                        if (!is_null($storeId2)) {
                            $pageStore2 = Mage2CmsPageStore::model()->find("page_id = {$model2->page_id} AND store_id = {$storeId2}");
                            if (!$pageStore2) {
                                $pageStore2 = new Mage2CmsPageStore();
                                $pageStore2->store_id = $storeId2;
                                $pageStore2->page_id = $model2->page_id;
                            } else {
                                //update
                                $pageStore2->store_id = $storeId2;
                            }
                            //save/update
                            if (!$pageStore2->save()) {
                                $this->errors[] = get_class($pageStore2) . ": " . UBMigrate::getStringErrors($pageStore2->getErrors());
                            } else {
                                $this->_traceInfo();
                            }
                        }
    ...
    private function _migrateReviewSummary($models, $mappingStores)
    {
        ...
        foreach ($models as $model) {
            ...
            if (!is_null($storeId2)) {
                ...
                if (is_null($m2Id)) {
                    //check for new unique key added from CE2.4.0: entity_pk_value-store_id-entity_type
                    $reviewCode = UBMigrate::getM1ReviewEntityCode($model->entity_type);
                    if ($reviewCode == 'product') {
                        $entityPKValue2 = (!$keepProductId) ? UBMigrate::getM2EntityId(5, 'catalog_product_entity', $model->entity_pk_value) : $model->entity_pk_value;
                    } elseif ($reviewCode == 'customer') {
                        $entityPKValue2 = (!$keepCustomerId) ? UBMigrate::getM2EntityId(6, 'customer_entity', $model->entity_pk_value) : $model->entity_pk_value;
                    } elseif ($reviewCode == 'category') {
                        $entityPKValue2 = UBMigrate::getM2EntityId(4, 'catalog_category_entity', $model->entity_pk_value);
                    }
                    $entityType2 = UBMigrate::getM2ReviewEntityId($reviewCode);
                    $uniqueCon = "entity_pk_value = {$entityPKValue2} AND store_id = {$storeId2} AND entity_type = {$entityType2}";
                    $model2 = Mage2ReviewEntitySummary::model()->find($uniqueCon);
                    if (!$model2) {
                        $canReset = UBMigrate::RESET_YES;
                        //add new
                        $model2 = new Mage2ReviewEntitySummary();
                        $model2->primary_id = null;
                        $model2->entity_pk_value = $entityPKValue2;
                        $model2->store_id = $storeId2;
                        $model2->entity_type = $entityType2;
    ...
    private function _migrateEmailTemplates($emailTemplates)
    {
        foreach ($emailTemplates as $model) {
            ...
            if (!$model2) {
                ...
                //Because M2 has changed config_path of some core email templates
                $model2->template_text = preg_replace(
                    "/{{template config_path=\"design\/email\/header\"}}/",
                    "{{template config_path=\"design/email/header_template\"}}",
                    $model2->template_text
                );
                $model2->template_text = preg_replace(
    ...
    protected static function _getM2PageLayout($layout1 = null) {
        $layout2 =  null;
        $mapping = array(
            'one_column' => '1column',
        ...
        if ($layout1) {
            $layout2 = isset($mapping[$layout1]) ? $mapping[$layout1] : null;
        }
